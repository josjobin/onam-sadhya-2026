...
function SuccessReceipt() {
  ...
  // This dynamically pulls the actual order ID from the URL bar
  const orderId = searchParams.get("order") || "Pending";
...
export default function SuccessPage() {
  return (
    <main className="min-h-screen bg-neutral-50 flex items-center justify-center p-6 font-sans">
      ...
      <Suspense fallback={<div className="text-emerald-700 font-bold animate-pulse">Loading Receipt...</div>}>
        <SuccessReceipt />
      </Suspense>
    </main>
  );
